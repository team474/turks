...
export const BorderBeam = ({
  ...
  return (
    <div
      ...
      style={{
        // Create a 1:1 "border" region using padding and mask so the beam only shows on edges
        padding: borderWidth,
        // Use robust mask shorthand with WebKit fallback similar to shiny-button
