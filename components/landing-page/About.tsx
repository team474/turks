  ...
  return (
    <div className="group flex flex-col md:flex-row items-center justify-between gap-12 md:gap-12 2xl:gap-20 transition-all duration-300" style={accentVars}>
      ...
      <div className="flex max-w-[570px] w-full flex-col items-start gap-12">
        ...
        >
          <div className="absolute inset-0 opacity-[0.15] group-hover:opacity-20 transition-opacity duration-300 pointer-events-none select-none overflow-hidden">
            <svg xmlns="http://www.w3.org/2000/svg" className="absolute right-4 top-4 w-[120px] h-[120px]" viewBox="0 0 96 97" fill="none">
          ...
          <div className="p-6 md:p-8 lg:p-10 relative z-10">
            <div className="flex flex-col justify-center items-center gap-4">
              ...
              <RichTextRenderer
                ...
                className="flex flex-col items-center gap-3 text-base md:text-xl font-normal leading-[150%] text-[#101010] text-center"
              />
              <div className="pt-2">
                <Button title="Shop Now" link="#strain" className="self-center" />
              </div>
            </div>
          </div>
        </div>
